...
public class ObeliskPurchaseDefenceUI extends Screen {
    ...
    protected Item handleItem(@NotNull ItemData itemData) {
        if (itemData.getITEM_ID().equals("DEFENCE")) {
            ...
            return new ObeliskPaginatedDefenceItem(itemData, SpigotGUIAPI.createItem(itemData, player.getUniqueId()), struct, false, obeliskType, faction, player);
        }
        ...
        return switch (itemData.getITEM_ID()) {
            ...
            case "CONFIRM" ->
                    new ObeliskConfirmPurchaseItem(itemData, SpigotGUIAPI.createItem(itemData, player.getUniqueId()), obeliskType, struct, faction, player);
