...
public enum Messages {
    ...
    MODIFYING_LANGUAGE("MODIFYING_LANGUAGE"),
    LANGUAGE_MODIFIED("LANGUAGE_MODIFIED"),
    ...
    GEMS_PAY_SUCCESS("Gems.GEMS_PAY_SUCCESS"),
    GEMS_PAY_NOTIFY("Gems.GEMS_PAY_NOTIFY"),
    ...
    FACTION_PLAYER_ISLAND_REQUIRED("Factions.FACTION_CREATION.PLAYER_ISLAND_REQUIRED"),
    ...
    FACTION_LEAVE_OWNER_CONFIRMATION_LORE("Factions.FACTION_LEAVE.OWNER_CONFIRMATION_LORE"),
    ...
    FACTION_MANAGE_RANK_SELECTED("Factions.FACTION_MANAGE.SELECTED"),
    RANK_CHANGE_SUCCESS("Factions.FACTION_MANAGE.RANK_CHANGE_SUCCESS"),
    FACTION_MANAGE_HIGHER_RANKS_DENY("Factions.FACTION_MANAGE.MANAGE_HIGHER_RANKS_DENY"),
    FACTION_MANAGE_HIGHER_RANKS_DENY_LORE("Factions.FACTION_MANAGE.MANAGE_HIGHER_RANKS_DENY_LORE"),
    FACTION_MANAGE_NO_PERMISSIONS("Factions.FACTION_MANAGE.MANAGE_NO_PERMISSIONS"),
    FACTION_MANAGE_NO_PERMISSIONS_LORE("Factions.FACTION_MANAGE.MANAGE_NO_PERMISSIONS_LORE"),
    ...
    FACTION_INVITE_PLAYER_BANNED("Factions.FACTION_INVITE.INVITE_PLAYER_BANNED"),
    FACTION_INVITE_REQUEST_JOIN_BANNED("Factions.FACTION_INVITE>REQUEST_JOIN_BANNED"),
    ...
    FACTION_RENAME_ON_COOLDOWN("Factions.FACTION_RENAME.RENAME_ON_COOLDOWN"),
    FACTION_RENAME_NO_PERMISSIONS("Factions.FACTION_RENAME.RENAME_NO_PERMISSIONS"),
    FACTION_RENAME_INSUFFICIENT_FUNDS("Factions.FACTION_RENAME.RENAME_INSUFFICIENT_FUNDS"),
    ...
    RUNES_RESET_SUCCESS("Runes.RUNES_RESET_SUCCESS"),
