    ...
    protected Item handleItem(@NotNull ItemData itemData) {
        return switch (itemData.getITEM_ID()) {
            ...
            case "OUTGOING_INVITES" ->
                    new OutgoingInvitesTypeItem(itemData, SpigotGUIAPI.createItem(itemData, player.getUniqueId()), player);
            case "INCOMING_INVITES" ->
                    new JoinRequestsTypeItem(itemData, SpigotGUIAPI.createItem(itemData, player.getUniqueId()), "faction", player);
            case "BACK" ->
