...
import net.skullian.skyfactions.core.api.SpigotGemsAPI;
...
public class PlaceholderAPIHook extends PlaceholderExpansion {
    ...
    public String onRequest(OfflinePlayer player, @NotNull String params) {
        ...
        if (params.equalsIgnoreCase("player_runes")) {
            ...
            if (player == null) return "UNKNOWN PLAYER";
            if (SpigotFactionAPI.factionCache.containsKey(player.getUniqueId()))
                return TextUtility.legacyColor(SpigotFactionAPI.getCachedFaction(player.getUniqueId()).getRank(player.getUniqueId()), SpigotPlayerAPI.getLocale(player.getUniqueId()), player);
            else return TextUtility.legacyColor("&cN/A", locale, player);
        }
        return null;
    }
