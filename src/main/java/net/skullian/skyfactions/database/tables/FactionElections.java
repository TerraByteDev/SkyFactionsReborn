...
import net.skullian.skyfactions.database.tables.Factions.FactionsPath;
...
public class FactionElections extends TableImpl<FactionElectionsRecord> {
    ...
    /**
     * The column <code>faction_elections.faction_name</code>.
     */
    public final TableField<FactionElectionsRecord, String> FACTION_NAME = createField(DSL.name("faction_name"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>faction_elections.end_date</code>.
     */
    public final TableField<FactionElectionsRecord, LocalDateTime> END_DATE = createField(DSL.name("end_date"), SQLDataType.LOCALDATETIME(0), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.FACTION_ELECTIONS_FACTION_NAME_INDEX);
    }
    ...
    @Override
    public List<ForeignKey<FactionElectionsRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FACTION_ELECTIONS__FK_FACTION_ELECTIONS_PK_FACTIONS);
    }

    private transient FactionsPath _factions;

    /**
     * Get the implicit join path to the <code>factions</code> table.
     */
    public FactionsPath factions() {
        if (_factions == null)
            _factions = new FactionsPath(this, Keys.FACTION_ELECTIONS__FK_FACTION_ELECTIONS_PK_FACTIONS, null);
