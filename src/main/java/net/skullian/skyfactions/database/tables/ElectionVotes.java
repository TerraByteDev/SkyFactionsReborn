...
public class ElectionVotes extends TableImpl<ElectionVotesRecord> {
    ...
    /**
     * The column <code>election_votes.voted_for</code>.
     */
    public final TableField<ElectionVotesRecord, String> VOTED_FOR = createField(DSL.name("voted_for"), SQLDataType.CLOB, this, "");
