...
public class PlayerInviteTypeSelectionUI {
    ...
    public static void promptPlayer(Player player) {
        try {
            GUIData data = GUIAPI.getGUIData(GUIEnums.OBELISK_PLAYER_INVITE_TYPE_SELECTION_GUI.getPath(), player);
    ...
    private static Gui.Builder.Normal registerItems(Gui.Builder.Normal builder, Player player) {
        try {
            List<ItemData> data = GUIAPI.getItemData(GUIEnums.OBELISK_PLAYER_INVITE_TYPE_SELECTION_GUI.getPath(), player);
