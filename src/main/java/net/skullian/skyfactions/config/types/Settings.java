...
public enum Settings {
    ...
    FACTION_BAN_PERMISSIONS("Factions.RANKS.BAN"),
    FACTION_KICK_PERMISSIONS("Factions.RANKS.KICK"),
    FACTION_MANAGE_RANK_PERMISSIONS("Factions.RANKS.MANAGE_RANK"),
    FACTION_MODIFY_MOTD_PERMISSIONS("Factions.RANKS.MODIFY_MOTD"),
    FACTION_MANAGE_INVITES_PERMISSIONS("Factions.RANKS.MANAGE_INVITES"),
    FACTION_CREATE_BROADCAST_PERMISSIONS("Factions.RANKS.CREATE_BROADCAST"),
