...
public enum Messages {
    ...
    JOIN_REQUEST_DUPLICATE("Factions.FACTION_INVITE.JOIN_REQUEST_DUPLICATE"),
    ...
    JOIN_REQUEST_NOTIFICATION("Notifications.JOIN_REQUEST_NOTIFICATION"),
    FACTION_INVITE_NOTIFICATION("Notifications.INVITE_NOTIFICATION"),
