...
public enum Messages {
    ...
    FACTION_CREATION_PROCESSING("Factions.FACTION_CREATE_PROCESSING"),
    FACTION_NAME_LENGTH_LIMIT("Factions.NAME_LENGTH_LIMIT"),
    FACTION_NO_NUMBERS("Factions.NAME_NO_NUMBERS"),
